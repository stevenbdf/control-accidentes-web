const Home = () => {
  return (
    <div className="flex space-x-2 mx-8 md:flex md:flex-col items-center">
      <div className="w-6/12  border-2 border-gray-300 mt-12 flex flex-col justify-center space-y-16 items-center rounded-lg md:w-10/12 md:text-center">
        ...
        <div className="text-4xl font-semibold">Desde 1/1/2021</div>
      </div>
      <div className="w-6/12 h-auto border-2 border-gray-300 mt-12 flex flex-col rounded-lg md:w-10/12" >
        <div className="mb-1">
